# Manages user data deletion (Ctrl+Alt+R) key binding.
...
# For deleting a folder and all it's contents.
...
# User chooses what to delete and then enters the name of the content. Above functions are called accordingly.
