# Manages the workflow of functions which display the content the user has uploaded in the bucket. (Ctrl+R key binding)
...
# Returns names of the files, folders and passwords in the bucket username.
...
# Creates an s3 bucket with the name "username"
...
# Printing the data owned by the user in a sorted pattern.
